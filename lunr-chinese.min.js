 ...
 */
o.stemmer=function(){var e={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},t={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},n="[aeiouy]",i="[^aeiou][^aeiouy]*",r=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*"),o=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*"),s=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*([aeiouy][aeiou]*)?$"),a=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy]"),u=/^(.+?)(ss|i)es$/,h=/^(.+?)([^s])s$/,l=/^(.+?)eed$/,c=/^(.+?)(ed|ing)$/,f=/.$/,p=/(at|bl|iz)$/,d=new RegExp("([^aeiouylsz])\\1$"),v=new RegExp("^"+i+n+"[^aeiouwxy]$"),m=/^(.+?[^aeiou])y$/,g=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,y=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,S=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,w=/^(.+?)(s|t)(ion)$/,x=/^(.+?)e$/,k=/ll$/,b=new RegExp("^"+i+n+"[^aeiouwxy]$");return function(n){var i,E,_,F,z,O,P;if(n.length<3)return n;if(_=n.substr(0,1),"y"==_&&(n=_.toUpperCase()+n.substr(1)),F=u,z=h,F.test(n)?n=n.replace(F,"$1$2"):z.test(n)&&(n=n.replace(z,"$1$2")),F=l,z=c,F.test(n)){var T=F.exec(n);F=r,F.test(T[1])&&(F=f,n=n.replace(F,""))}else if(z.test(n)){var T=z.exec(n);i=T[1],z=a,z.test(i)&&(n=i,z=p,O=d,P=v,z.test(n)?n+="e":O.test(n)?(F=f,n=n.replace(F,"")):P.test(n)&&(n+="e"))}if(F=m,F.test(n)){var T=F.exec(n);i=T[1],n=i+"i"}if(F=g,F.test(n)){var T=F.exec(n);i=T[1],E=T[2],F=r,F.test(i)&&(n=i+e[E])}if(F=y,F.test(n)){var T=F.exec(n);i=T[1],E=T[2],F=r,F.test(i)&&(n=i+t[E])}if(F=S,z=w,F.test(n)){var T=F.exec(n);i=T[1],F=o,F.test(i)&&(n=i)}else if(z.test(n)){var T=z.exec(n);i=T[1]+T[2],z=o,z.test(i)&&(n=i)}if(F=x,F.test(n)){var T=F.exec(n);i=T[1],F=o,z=s,O=b,(F.test(i)||z.test(i)&&!O.test(i))&&(n=i)}return F=k,z=o,F.test(n)&&z.test(n)&&(F=f,n=n.replace(F,"")),"y"==_&&(n=_.toLowerCase()+n.substr(1)),n}}(),o.Pipeline.registerFunction(o.stemmer,"stemmer"),/*!
 * lunr.stopWordFilter
 * Copyright (C) 2016 Oliver Nightingale
 */
